...
export default function connect() {
  ...
  process.on("SIGINT", async () => {
    try {
      ...
      // encerrar apenas uma conexão específica
      // garante que a conexão com o MongoDB seja fechada corretamente, liberando recursos e encerrando as operações pendentes
